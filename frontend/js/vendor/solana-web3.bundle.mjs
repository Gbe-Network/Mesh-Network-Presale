...
// js/vendor/node_modules/base64-js/index.js
var require_base64_js = __commonJS({
  "js/vendor/node_modules/base64-js/index.js"(exports) {
    "use strict";
    init_inject_buffer();
...
// js/vendor/node_modules/ieee754/index.js
var require_ieee754 = __commonJS({
  "js/vendor/node_modules/ieee754/index.js"(exports) {
    init_inject_buffer();
...
// js/vendor/node_modules/buffer/index.js
var require_buffer = __commonJS({
  "js/vendor/node_modules/buffer/index.js"(exports) {
    "use strict";
    init_inject_buffer();
    ...
    (function(module2, exports2) {
      ...
      try {
        if (typeof window !== "undefined" && typeof window.Buffer !== "undefined") {
          ...
          Buffer5 = require_buffer3().Buffer;
        }
      } catch (e) {
      }
...
var Account = class {
   ...
   */
  get secretKey() {
    return import_buffer3.Buffer.concat([this._secretKey, this._publicKey], 64);
  }
};
...
var Secp256k1Program = class _Secp256k1Program {
  ...
  static publicKeyToEthAddress(publicKey2) {
    ...
    try {
      return import_buffer3.Buffer.from(keccak_256(toBuffer(publicKey2))).slice(-ETHEREUM_ADDRESS_BYTES);
    } catch (error) {
  ...
  static fromConfigData(buffer) {
    ...
    if (configKeys[0].publicKey.equals(VALIDATOR_INFO_KEY)) {
      if (configKeys[1].isSigner) {
        const rawInfo = rustString().decode(import_buffer3.Buffer.from(byteArray));
